...
public class FragIMG extends Fragment implements MateriView{
    ...
    private MateriImageAdapter adapter;
    ...
    public static FragIMG newInstance(String nama_room, int id_guru) {
        FragIMG fragIMG = new FragIMG();
        Bundle args = new Bundle();
        args.putString(ARG_NAME, nama_room);
        args.putInt(ARG_ID, id_guru);
        fragIMG.setArguments(args);
        return fragIMG;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.frag_img, container, false);
        ...
        presenter.getImage(nama_room, id_guru);
    ...
    public void onGetFile(List<modelMateri> models) {
        adapter = new MateriImageAdapter(getContext(), models, itemClickListener);
